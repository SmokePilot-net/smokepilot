...
def serve_agent_installer(slave_id):
    ...
    script = f"""#!/bin/bash
set -e
# SmokePilot Agent — auto-installer for slave: {slave['display_name'] or slave['name']}
...
echo ""
echo "  IMPORTANT: Edit /etc/smokepilot-agent.env and set SPM_SLAVE_KEY"
...
echo ""
echo "=== Done ==="
echo "  1. Set the API key: sudo nano /etc/smokepilot-agent.env"
